...
### **Objectif**
Implémenter un algorithme qui permettrait de maximiser le nombre d'articles par carton, en utilisant TypeScript pouvant être exécuté sur une JVM ou en node.js.
